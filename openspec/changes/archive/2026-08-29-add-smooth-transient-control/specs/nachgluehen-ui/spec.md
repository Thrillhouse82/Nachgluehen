...
The editor SHALL present the MVP controls needed for Freeze, Drift, Smooth, Dry/Wet, and Output Gain: a dedicated toggle for Freeze and equal-sized rotary controls for Drift, Smooth, Dry/Wet, and Output Gain. Each rotary control SHALL use the same visual size and look-and-feel treatment; labels and status information SHALL NOT reduce any rotary control's size.

#### Scenario: Controls are discoverable
- **WHEN** the plugin editor is opened
- **THEN** the user can identify and operate Freeze, Drift, Smooth, Dry/Wet, and Output Gain without relying on a standard desktop checkbox for Freeze
...
- **THEN** the Drift, Smooth, Dry/Wet, and Output Gain controls have equal width, height, circular display size, and rotary look-and-feel presentation
