...
private:
    ...
    juce::Slider driftSlider, dryWetSlider;
    juce::Label title, driftLabel, dryWetLabel;
    std::unique_ptr<juce::AudioProcessorValueTreeState::ButtonAttachment> freezeAttachment;
    std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment> driftAttachment, dryWetAttachment;
